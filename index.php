...
<body>
        ...
        <div class="container">
            <nav class="main-nav">
                ...
                <ul class="main-menu" style="font-size: 17px; font-weight: 500;">
                    <li><a href="index.php" style="color:#1453a0;">Inicio</a></li>
                    <li><a href="aplicante/body.php" style="color:#1453a0;">Candidatos</a></li>
                    <li><a href="empresa/body.php" style="color:#1453a0;">Organizaciones</a></li>
                </ul>
                <ul class="right-menu">
                    <a href="login.php">
                        <button>Iniciar sesión</button>
                    </a>
                    <div class="menu-btn" style="font-weight: 800;">|||</div>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <section>
            ...
            text-align: center;">Te acompañamos en:
            </h2>
    </section>
    <div class="container">
        <section class="cards">
            <div class="cardsa">
                <div class="cardsbga">
                    <div class="cards_text">
                        <h2>LA BUSQUEDA DEL
                            TRABAJO DESEADO
                            ACORDE A TU POTENCIAL Y
                            FUNCIONES DE MAYOR
                            GUSTO.</h2>
                            <a href="https://serenaccion.com.co/login.php?tipo=aplicante"><button>Ir al portal candidatos</button></a>
                    </div>
                </div>
            </div>
            <div class="cardsb">
                <div class="cardsbgb">
                    <div class="cards_text">
                        <h2>LA SELECCIÓN DE
                            CANDIDATOS QUE "SABEN
                            HACER" Y TIENEN EL
                            POTENCIAL QUE
                            REQUIERES.</h2>
                            <a href="https://serenaccion.com.co/login.php?tipo=empresa"><button>Ir al portal organizaciones</button></a>
                    </div>
                </div>
            </div>
        </section>
        <section>
            <h2 style="color:#1453a0;
            text-align: center;">¿Que opinan nuestros usuarios?
            </h2>
        </section>
        <section class="home-cards">
            <div>
                <img src="../images/testimonial2.png" alt="">
                <h2>Paola Rivera - Candidata</h2>
                <h3>
            ...
            <div>
                ...
                <h2>Luis Alejandro Camargo - Empresario</h2>
                <h3>
        ...
        <section class="ods light">
            <div class="content">
                <h3>SER EN ACCIÓN te ayuda a ser una compañía que actua en torno a</h3>
                <h2>LA SOSTENIBILIDAD PRODUCTIVA PARA UN MEJOR MAÑANA</h2>
                <h3>Contribuyendo positivamente al ser humano, a la sociedad y a la economía. Objetivo de Desarrollo
                    Sostenible Equidad de Género (ODS 5), Trabajo Decente (ODS 8) y
                    Disminución de desigualdades (ODS 10).</h3>
            </div>
        </section>
        <section>
    ...
    <section class="links">
        <div class="links-inner">
            <div class="logo_footer">
                ...
                <p>En SER en Acción, estamos moldeando el proceso de reclutamiento para fomentar la igualdad de oportunidades y encontrar el mejor talento para cada posición.</p>
                <div class="follow">
                    <a href="https://www.instagram.com/serenaccion.com.co">
            ...
            <ul>
                ...
                <li><a href="https://serenaccion.com.co/Pol_trat_dat.html">Tratamientos de datos</a></li>
            </ul>
        </div>
    </section>
    </div>
