    ...
    <form id="box" name="vacante" class="form" action="../controlers/submit.php" method="POST">
        ...
        <div class= "subcontenedor">
            <div class="bloque activo" id='bl1'>
                ...
                ?>
                    <div class="caja">
                        <label for="otras_comp_lab_div">O agregue sus propias definiciones de competencias laborales</label>
                ...
                ?>
                <div class='caja'>
                    <label for="otras_comp_per_div">O agregue sus propias definiciones de competencias personales</label>
            ...
            <div class="bloque" id='bl3'>
                ...
                <?php
                    ...
                    $constructor->selectElement('jorn_labo_sema', 'jorn_labo_sema', '<h6>Escoja el tipo de jornada laboral (por días a la semana) que tendrá su vacante</h6>', $vacante?$vacante['jorn_labo_sema_vacante']:$empresa['jorn_labo_sema_empresa'],'Jornada Laboral Semanal', 'caja', '', 'chosen_select', '', 'required', '');
                    $constructor->selectElement('jorn_labo_dia', 'jorn_labo_dia', '<h6>Escoja la jornada laboral que tendrá su vacante</h6>', $vacante?$vacante['jorn_labo_dia_vacante']:$empresa['jorn_labo_dia_empresa'],'Jornada Laboral Diaria', 'caja', '', 'chosen_select', '', 'required', '');
            ...
            <div class="bloque" id='bl4'>
                ...
                <a id="submit" class="btn btn-confirm alternative">Guardar</a>
            </div>
        </div>
        <?php
